...
'<div id="selectionMenu" class="selectionMenu">\
    ...
    <div id="SortingAlgorithms" class="selectionBlock">\
        ...
        <a class="selectionItem" href="#">Merge Sort</a>\
        <a class="selectionItem" href="#">Quick Sort</a>\
        <a class="selectionItem" href="#">Heap Sort</a>\
    ...
    <div id="Mathematics" class="selectionBlock">\
        ...
        <a class="selectionItem" href="#">Extended Euclidean algorithm</a>\
        <a class="selectionItem" href="#">Euler&prime;s Function</a>\
        <a class="selectionItem" href="#">Fermat&prime;s little theorem</a>\
        <a class="selectionItem" href="#">Modular Multiplicative Inverse</a>\
        <a class="selectionItem" href="#">Catalan Number</a>\
    ...
    <div id="Graph Theory And Tree" class="selectionBlock">\
        ...
        <a class="selectionItem" href="#">Euler Circuit and Path</a>\
        <a class="selectionItem" href="#">Hamiltonian Circuit and Path</a>\
        <a class="selectionItem" href="#">Lowest Common Ancestor</a>\
        <a class="selectionItem" href="#">Euler Tour Of Tree</a>\
        <a class="selectionItem" href="#">Heavy Light Decomposition</a>\
        <a class="selectionItem" href="#">DSU on Tree</a>\
        <a class="selectionItem" href="#">Tarjan Algorithm</a>\
        <a class="selectionItem" href="#">Minimun Spanning Tree</a>\
